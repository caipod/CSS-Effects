...
✨**亮点：** 整个网站中用到切图的地方仅有第八张卡片的两个绿色半圆以及网站的Favorite Icon，其他内容和动效都是代码写出来的。
...
测试浏览器或操作系统是否支持显示多种字重。对于西文，我设置了 100～900 与 Bold 字重。对于中文，我设置了 100～600 与 Bold 字重，同时也设置了Bold与Bolder的样式，我将 Regular(400) 字重设为了蓝色，方便对比。把鼠标悬浮在文字上，会出现文字放大效果。
