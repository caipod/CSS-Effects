...
🔮**灵感：** 最初的灵感来源于爱否4老师的[博客](https://frankseptillion.com)的[测试页面](https://frankseptillion.com/test/)，并且希望借此机会学习HTML与CSS代码，所以做了这个网站。

✒️**设计：** 该网站的整体颜色采用明快的蓝绿色和冷色搭配，让人感到非常愉悦。第一张卡片的背景颜色设计非常鲜艳，这是为了突出主题。由于其他卡片的背景颜色都是以白色为主，因此需要采用重色彩来制造抑扬顿挫的效果。
